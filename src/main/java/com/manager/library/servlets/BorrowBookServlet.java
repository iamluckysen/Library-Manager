    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(!bBookId.trim().isEmpty() && bBookId!=null){
            try{
                ...
                if(book!=null){
                    if(libraryService.borrowBook(book,student))
                        isBorrowed = true;
                    req.setAttribute("isBorrowed",isBorrowed);
                    req.setAttribute("borrowedBook",book);
                }else {
        ...
        req.getRequestDispatcher("borrowBook.jsp").forward(req,resp);
