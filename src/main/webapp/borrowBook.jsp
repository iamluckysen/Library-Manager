...
<%
    ...
    Boolean isBorrowed = (Boolean)request.getAttribute("isBorrowed");
    ...
    <div class="bg-card">
        <h2 style="margin-top: 10px;">Borrow A Book</h2>
        ...
        <% if (borrowedBook != null && isBorrowed==true) { %>
            <div class="result-box">
                <h3 style="margin-top: 0; text-align: center; color: #00ffff;">This Book Has Been Borrowed</h3>
                <p><strong>ID:</strong> <%= borrowedBook.getId() %></p>
                <p><strong>Title:</strong> <%= borrowedBook.getName() %></p>
                <p><strong>Author:</strong> <%= borrowedBook.getAuthor() %></p>
                <p><strong>Available:</strong> <%= borrowedBook.getTotalQuantity() %></p>
            </div>
        <% }%>
